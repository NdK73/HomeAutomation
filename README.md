...
All HW designs were in [KiCAD](https://kicad.org/) 4.0.x (will follow what's packaged in latest [Ubuntu LTS](https://www.ubuntu.com/)) so not to require nonstandard installs. But 5.x introduced too many new features not to be used, and it's "easy enough" to install ([official instructions](https://kicad.org/download/ubuntu/)).
